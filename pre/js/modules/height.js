...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '662px';
        document.getElementsByClassName('main')[0].style.height = '634px';
        ...
        let height = 634; //Altura total del main
